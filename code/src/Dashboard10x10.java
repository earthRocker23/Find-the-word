 ...
 */
public class Dashboard10x10 extends Dashboard implements DashboardsInterface{
    private ArrayList<String> list = new ArrayList<String>();//list me oles tis lekseis pou exume kanei save sto .txt
    private ArrayList<String> WordsToUse = new ArrayList<String>();//list me oles tis lekseis pou MPORUME na xrisimopoiisume sto 10x10
    private ArrayList<Letter> letterList = new ArrayList<Letter>();
    private char[][] array = new char[10][10];
    private char[] tempArray = new char[100];
    private Letter[][] letterArray = new Letter[10][10];
    
    public Dashboard10x10(String nickname, int score, int lives, int tries) {
    ...
    public void ShuffleTheWords() {
        ...
        String str = AllWordsToStringPlusRandomChars(90, list, WordsToUse);        
        /**
...
//        tempArray = str.toCharArray();
        ...
        super.OneDto2D(10, tempArray, array);;
    }
    ...
    public void FindLetter() {
        ...
        super.OneDto2D(10, letterList, letterArray);
//        PrintArray();
    }
